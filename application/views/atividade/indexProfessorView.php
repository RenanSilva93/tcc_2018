...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-2">
            <a href="<?php echo base_url() . 'index.php/usuario/listaUsuario'; ?>"><img src="<?php echo base_url('include/imagem/botaoListaUsuarios.png') ?>" alt="Listar Usuarios" class="img-responsive" style="width: 100%;height: 160px"></a>
        </div>
